...
function CardReward({ title, description, image, minPledge, limit, estDeliveryMonth, estDeliveryYear }) {
      ...
      <div className="w-full block h-full">
        ...
        <div className="bg-white w-full p-4 flex flex-col pt-4">
          ...
          <div className="flex justify-center mt-4">
            <button className="rounded-lg bg-green-700 text-white w-full h-10">${minPledge} OR MORE</button>
          </div>
          ...
          <div className="flex flex-start text-xs mt-3">
            <BsCalendarCheck />
            <h1 className="ml-1"> Est. delivery is {estDeliveryMonth} {estDeliveryYear}</h1>
          </div>
        </div>
      </div>
    </div>
