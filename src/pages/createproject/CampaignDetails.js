      ...
      <div className="col-span-3">
        <div className="flex flex-col justify-center py-5 px-2">
          ...
          <div className="w-10/12 mx-auto flex flex-col">
            ...
            <select name="" id="" className="border border-gray-500 my-2 p-2">
            ...
            <div>
              <label
                htmlFor=""
                className="p-2 bg-purple-500 rounded-l-sm text-white"
              >
                USD
              </label>
              <input type="text" className="border border-gray-500 my-2 p-2" />
            </div>
